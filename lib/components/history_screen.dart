        ...
        children: [
          ...
          FutureBuilder(
            ...
            builder: (context, snapshot) {
              ...
              // firstFourProduct.clear();
              // restOfTheProduct.clear();
              if (product.length > 4) {
                for (int i = 0; i < 4; i++) {
                  ...
                  print(firstFourProduct);
                }
                for (int i = 4; i < product.length; i++) {
                  restOfTheProduct.add(
                    RecentCard(
                      imgURL:
                          'https://i.pinimg.com/736x/83/bf/5b/83bf5b1a398fd61853748b7aa48657ab.jpg',
                      shopName: product[i]['shop_name'],
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemCount: firstFourProduct.length,
                                  itemBuilder: (context, index) {
                                    return firstFourProduct[index];
                                  },
                                ),
                              ),
                            ),
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemCount: restOfTheProduct.length,
                                  itemBuilder: (context, index) {
                                    return restOfTheProduct[index];
                                  },
                                ),
                              ),
                            ),
